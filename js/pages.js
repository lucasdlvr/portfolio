...
ScrollReveal().reveal('.media-icons i, .contact-left li', { delay: 300, origin: 'left', interval: 100 });
...
ScrollReveal().reveal('.experience-card, .service-card, .education, .portfolio .img-card', { delay: 600, origin: 'bottom', interval: 100 });
